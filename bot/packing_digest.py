...
(не автоматично о 12:00). О 14:00 Київ — лише нові замовлення з вкладки «На пакування» після
останнього надісланого списку. «Наступна відправка» в групу не потрапляє.
"""
